 ...
 * @author dcmr3 & axmr5
 */
public class CajeroProducto2 implements Runnable {
     ...
     */
    public CajeroProducto2(String nombre) {
        this.nombre = nombre;
    }

    public CajeroProducto2() {
    }
    ...
    public void run() {
         ...
         */
        ClienteProducto cliente2 = new ClienteProducto(" ANGIE", productos);
        /**
         * instanciación del cajero y asigancion del nombre con tiempo de inicio
         * en ejecucion
         */
        long initialTime = System.currentTimeMillis();
        CajeroProducto2 cajero2 = new CajeroProducto2(" Cajero 2");

        cajero2.run(cliente2, initialTime);
    ...
    private static void setProductos(List<Producto> productos) {
        Producto producto1 = new Producto("lapiz", 6, 1.200);
        Producto producto2 = new Producto("esfero", 6, 1.500);
        Producto producto3 = new Producto("cuaderno", 6, 5.000);
        /**
         * llenado del array
         */
